...
Here is the code to help your program reading and storing the maze. [\[src code\]](../codes/algorithms/maze\_parser.py)
...
**Sol.** [\[src code\]](../codes/algorithms/dfs\_maze.py)
